...
public class Blue_Freight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d startPose = new Pose2d(10, -65, Math.toRadians(270));
        ...
        Trajectory Forward1 = drive.trajectoryBuilder(Place1.end())
                .forward(4)
                .build();

        Trajectory Duck1 = drive.trajectoryBuilder(Forward1.end())
                .back(2)
        ...
        Trajectory Forward2 = drive.trajectoryBuilder(Place2.end())
                .forward(4)
                .build();

        Trajectory Duck2 = drive.trajectoryBuilder(Forward2.end())
                .back(2)
                .splineToConstantHeading(new Vector2d(-57, 55), Math.toRadians(0))
                .build();
        ...
        Trajectory Duck3 = drive.trajectoryBuilder(Place3.end())
                .splineToConstantHeading(new Vector2d(12, 75), Math.toRadians(0))
                .build();

        Trajectory Park3 = drive.trajectoryBuilder(Duck3.end())
                .splineToConstantHeading(new Vector2d(35, 75), Math.toRadians(-270))
                .build();
        ...
        while (opModeIsActive()) {
            ...
            if (Object < 300 && Object > 1) {
                ...
                robot.LeftStrafe(0.14);
                robot.Off();
                robot.setShooterPower(-0.1);
                sleep(3000);
