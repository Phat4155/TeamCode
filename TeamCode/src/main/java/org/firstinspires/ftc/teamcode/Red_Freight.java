...
@Autonomous (name = "Roadrunner Red Freight", group = "Autonomous Main")
public class Red_Freight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory Place3 = drive.trajectoryBuilder(startPose)
                .splineToConstantHeading(new Vector2d(17, -30), Math.toRadians(90))
                .build();
        ...
        Trajectory Park3 = drive.trajectoryBuilder(Duck3.end())
                .splineToConstantHeading(new Vector2d(35, -75), Math.toRadians(-90))
                .build();
